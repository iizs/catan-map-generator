...
catanApp.directive('catanTile', function () {
  return {
    ...
    template: '<g transform="translate({{tile.x * 150}}, {{tile.y * -87 + tile.z * 87}})">'+
                ...
                '<circle ng-if="tile.type == \'dessert\'" cx="0" cy="-45" r="15" stroke="black" stroke-width="3" fill="black" />' +
                '<ellipse ng-if="tile.type == \'dessert\'" cx="0" cy="5" rx="25" ry="40" stroke="black" stroke-width="3" fill="black" />' +
                '<path ng-if="tile.type == \'dessert\'" d="M 30 45 A 30 30, 0, 0, 0, -30 45 Z" stroke="black" stroke-width="3" fill="black" />' +
                '</g>' +
                '</g>',
